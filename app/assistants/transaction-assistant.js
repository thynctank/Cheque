...
TransactionAssistant.prototype.setup = function() {
...
TransactionAssistant.prototype.deactivate = function(event) {
	/* remove any event handlers you added in activate and do any other cleanup that should happen before
	   this scene is popped or another scene is pushed on top */
};

TransactionAssistant.prototype.cleanup = function(event) {
